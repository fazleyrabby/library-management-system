        ...
        <div class="container">
            <div class="row">
                ...
                <form class="d-block mx-auto border col-12 mt-1 mb-5 pl-5 pr-55 m-height200" action="action/manageUserAction.php" method="post">
                    <h4 class="d-block text-center p-4 font-weight-bold">Edit user/subadmin name</h4>
                    <?php
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="username" class="form-control" value="<?=$name?>" placeholder="Enter Name" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12 text-center">
                            <button type="submit" id="submit" name="edit_username" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
